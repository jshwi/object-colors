...
class TestIgnoreCaseAndScatter:
    def test_exact_letter_in_string(
        self, all_colors: Color, small_test_string: str, all_cs_marked: str
    ) -> None:
        ...
        colored_keys = all_colors.red.get_key(
            small_test_string, "c", ignore_case=True, scatter=True
        )
        assert colored_keys == (
    ...
    def test_exact_word_in_string(
        ...
        """
        colored_keys = all_colors.red.get_key(
            small_test_string, "Cc:", ignore_case=True, scatter=True
        )
